      ...
      Blog Title"
        ...
        <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-900">
          ...
          <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
            ...
            <div className="col-span-full">
              <label htmlFor="bio" className="text-sm">
                Description Paragraph Main Body
              </label>
              <div className="w-full rounded-md focus:ring p-2 focus:ring-opacity-75 focus:ring-violet-400 dark:border-gray-700 text-gray-900 dark:text-gray-900">
                <CKEditor
            ...
            <div className="col-span-full">
              <label htmlFor="bio" className="text-sm">
                Description Paragraph After Image
              </label>
              <textarea
                id="bio"
                onChange={(e) => {
